            ...
            widget.transitionModel.productList?.forEach((element) {
              if (element.productId == products.productCode) {
                if (widget.transitionModel.customerType.contains('Retailer')) {
                  ...
                  sentProductPrice = products.productMrp;
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      SizedBox(width: 150, child: Text(lang.S.of(context).productName)),
                                                      SizedBox(width: 110, child: Text(lang.S.of(context).quantity)),
                                                      SizedBox(width: 70, child: Text("TAX")),
                                                      SizedBox(width: 80, child: Text(lang.S.of(context).price)),
                                                      ...
                                                      children: [
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            ///______TAx___________________________________________________________
                                                            SizedBox(
                                                              width: 80,
                                                              child: TextFormField(
                                                                ...
                                                                onChanged: (value) {
                                                                  if (value == '') {
                                                                    ...
                                                                    EasyLoading.showError('Enter a valid TAX');
                                                                  } else {
                                                                    setState(() {
                                                      ...
                                                      () {
                                                        ...
                                                        if (cartList.isEmpty) {
                                                          ...
                                                          SaleTransactionModel transitionModel = SaleTransactionModel(
                                                            ...
                                                            totalAmount: getTotalAmount().toDouble() + serviceCharge - discountAmount,
                                                          );
