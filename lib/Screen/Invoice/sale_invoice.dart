                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                          '$currency ${double.parse(widget.transitionModel.productList![index].subTotal) * widget.transitionModel.productList![index].quantity.toDouble()+double.parse(widget.transitionModel.productList![index].gstAmount) * widget.transitionModel.productList![index].quantity.toDouble() }'),
                                    ],
                                  ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  //   width: 120,
                                  //   child: Text(
                                  //     '$currency ${widget.transitionModel.gstTotalAmount}',
                                  //     maxLines: 2,
                                  //     style: kTextStyle.copyWith(color: kTitleColor, fontWeight: FontWeight.bold),
                                  //     textAlign: TextAlign.end,
                                  //   ),
