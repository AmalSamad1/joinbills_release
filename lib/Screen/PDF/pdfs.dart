            ...
            child: pw.Column(
              children: [
                pw.Table.fromTextArray(
                    ...
                    data: <List<String>>[
                      <String>['SL', 'Brand', 'Model number', 'HSN/SAC', 'Quantity', 'Unit Price','GST', 'Total Price'],
                      for (int i = 0; i < transactions.productList!.length; i++)
                        <String>[
                          ('${i + 1}'),
                          ...
                          (transactions.productList!.elementAt(i).gstType.toString())??"",
                          (double.parse(transactions.productList!.elementAt(i).subTotal) *
                              transactions.productList!.elementAt(i).quantity.toDouble() +
                              double.parse(transactions.productList!.elementAt(i).gstAmount)*transactions.productList!.elementAt(i).quantity.toDouble()).toString(),
                    ...
                    data: <List<String>>[
                      ...
                      for (int i = 0; i < transactions.productList!.length; i++)
                        <String>[
                          ...
                          transactions.productList!.elementAt(i).hsnSAC,
                    ...
                    data: <List<String>>[
                      ...
                      for (int i = 0; i < transactions.productList!.length; i++)
                        <String>[
                          ...
                          (transactions.productList!.elementAt(i).subTotal.toString()),
                          (transactions.productList!.elementAt(i).gstType.toString()),
                          (int.parse(transactions.productList!.elementAt(i).subTotal) * transactions.productList!.elementAt(i).quantity.toInt()).toString() + (int.parse(transactions.productList!.elementAt(i).gstAmount) * transactions.productList!.elementAt(i).quantity.toInt()).toString()
                        ],
                    ]),
                pw.Paragraph(text: ""),
                pw.Row(
