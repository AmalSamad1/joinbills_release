...
class _PosSaleState extends State<PosSale> {
  ...
  dynamic productPriceChecker({required ProductModel product, required String customerType}) {
    if (customerType == "Retailer") {
      ...
      return product.productMrp == '' ? '0' : product.productMrp;
  ...
  String getTotalAmount() {
    ...
    for (var item in cartList) {
      // Use null-aware operator and provide a default value of "0.0"
      double subTotal = double.tryParse(item.subTotal ?? "0.0") ?? 0.0;
      double gstAmount = double.tryParse(item.gstAmount ?? "0.0") ?? 0.0;

      total += (subTotal * item.quantity) + (gstAmount * item.quantity);
    }
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(width: 70, child: Text("Tax")),
                                                    SizedBox(width: 100, child: Text(lang.S.of(context).price)),
                                                    SizedBox(width: 70, child: Text(lang.S.of(context).subTotal)),
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          ///___________tax____________________________________________________
                                                          SizedBox(
                                                            width: 90,
                                                            child: TextFormField(
                                                              initialValue: cartList[index].gstType,
                                                              onChanged: (value) {
                                                                if (value == '') {
                                                                  setState(() {
                                                                    cartList[index].gstType = 0.toString();
                                                                  });
                                                                } else if (double.tryParse(value) == null) {
                                                                  EasyLoading.showError('Enter a valid Price');
                                                                } else {
                                                                  setState(() {
                                                                    cartList[index].gstType = value;
                                                                  });
                                                                }
                                                              },
                                                              onFieldSubmitted: (value) {
                                              ...
                                              children: [
                                                ...
                                                SizedBox(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Center(
                                                      child: Text(
                                                        '$currency ${(getTotalAmount().toDouble() + serviceCharge - discountAmount ).toStringAsFixed(1)}',
                                              ...
                                              itemBuilder: (_, i) {
                                                return Container(
                                                  ...
                                                  if (showProductVsCategory[i].serialNumber.isNotEmpty) {
                                                    ...
                                                    setState(() {
                                                      AddToCartModel addToCartModel = AddToCartModel(
                                                         gstAmount: showProductVsCategory[i].gstAmount,
                                                          gstType: showProductVsCategory[i].gstType,
                                                          nsnsac: showProductVsCategory[i].hsnSAC,
